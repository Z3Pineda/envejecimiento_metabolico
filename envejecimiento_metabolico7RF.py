...
model = joblib.load(r"C:\Users\zaira\Documents\ML_WORKS\InterdisciplinarMTH\random_forest_optimized.pkl")
...
uploaded_file = r"C:\Users\zaira\Documents\ML_WORKS\InterdisciplinarMTH\Final_Dataset_v.csv"
# Variables para el modelo predictivo
#selected_features = ["CINTURA","GLU",'WHtR', 'IMC', 'TASY', '', 'TADI', 'SEXO']
